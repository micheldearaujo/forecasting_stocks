...
with mlflow.start_run(run_name = RUN_NAME) as run:
    ...
    plt.savefig("artifacts/scatter_plot_lightgbm.png")
    fig.show()

    mlflow.log_artifact("artifacts/scatter_plot_lightgbm.png")

    mlflow.sklearn.log_model(model_fit, RUN_NAME)

    np.savetxt('artifacts/predictions_lightgbm.csv', predictions, delimiter=',')

    # Log the saved table as an artifact
    mlflow.log_artifact("artifacts/predictions_lightgbm.csv")
    ...
    plt.savefig("artifacts/residuals_plot_lightgbm.png")
    mlflow.log_artifact("artifacts/residuals_plot_lightgbm.png")
